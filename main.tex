...
\subsection{TODO:Refrigeration by Solidification of Liquid \textsuperscript{3}He: Pomeranchuck Cooling}
...
\subsection{TODO:Refrigeration by Adiabatic Demagnetization of a Paramagnetic Salt}
...
\subsection{TODO:Nuclear Adiabatic Demagnetization}
...
\subsection{TODO:Other techniques for refrigeration below 1 K}
...
\subsection{TODO:Introduction to the phenomenology of superconductivity}
...
\subsection{TODO:Vortex dynamics, vortex pinning}
...
\subsection{TODO:Review on superconducting materials (relevant for applications) and preparation methods}
...
\subsection{Iron-based superconductors (IBS)}
...
\subsubsection{Phase diagram and main properties}  
...
\end{itemize}
\subsubsection{Critical magnetic fields}
\begin{itemize}
...
\\\\
\paragraph{Coated conductors} based on IBSs are still in the early stages of development compared to more established superconductors like YBCO. However, their promising properties make them a subject of active research for future applications. \\
...
\paragraph{Applications of IBS Wires and Tapes}
...
\subsection{Hints on Superconducting Film Deposition}
...
\subsection{Cryoelectronic devices}
...
\subsubsection{Power applications}
...
\subsection{TODO:Material requirements}
\subsection{TODO:Substrate Requirements}
...
\subsubsection{NMR Applications in Pharmaceuticals, Biotechnology, Genomics and Materials Science}
\begin{itemize}
    \item High-Resolution Nuclear Magnetic Resonance (NMR) Spectroscopy.
    \item Magnetic Resonance Spectroscopic Imaging (MRSI)
\end{itemize}

\subsubsection{Industrial Processing}
\begin{itemize}
    \item Magnetic Separation 
    \item Induction Heating
\end{itemize}

\subsubsection{High-Energy Physics and Other Areas of Research}
\begin{itemize}
...
\subsubsection{Instrumentation, Sensors, Standards and Radar}
\begin{itemize}
...
\subsubsection{TODO:Neuromorphic Computing}
\begin{itemize}
...
\section{The Technology of Josephson Junctions}
\subsection{Josephsons Junctions:main concepts and phenomenology}
\subsubsection{The Josephson Effect: see the course "Quantum Condensed Matter Physics"}
...
\subsubsection{Josephson Equations}
...
\subsubsection*{a.c. Josephson Effect and Shapiro Steps}
...
\subsubsection{TODO:Energy in a Josephson Junction}
...
\subsubsection{Josephson Junction as Nonlinear Inductance}
...
\subsubsection{Hamiltonian of a Josephson Junction: see the course "Quantum Devices"}
...
\subsection{Current-Phase Relation and Junction Types}

\subsubsection{Different Types of Josephson Junctions: see the course "Quantum Condensed Matter Physics"}
...
\end{figure}
\subsubsection{Microscopic Mechanisms (Proximity Effect and Andreev Reflection)}
...
\subsubsection{Micro-restrictions and Grain Boundaries}
...
\subsection{Revisiting the Current-Phase Relation (CPR)}
...
\paragraph{Andreev Bound States (ABS):}
...
\paragraph{Generalized Current-Phase Relation:}
...
\end{center}
\paragraph{Anisotropic Order Parameter Symmetry:}
...
\paragraph{Second Harmonic Contributions:}
...
\subsection{SFS Josephson Junctions: The $\pi$ Junction}
...
\paragraph{Spatial Oscillations of the Order Parameter}
...
\end{center}
\paragraph{The $\pi$ Junction State}
...
\paragraph{Spontaneous Current and Magnetic Flux}
...
\end{center}
\paragraph{Applications in Superconducting Qubits}
...
\subsection{More on the SFS Junctions}
...
\end{center}
\subsubsection{High Harmonics in SFS Junctions}
...
\subsubsection{The $\phi$ Junction}
...
\paragraph{Critical Currents of the $\phi$ Junction}
...
\subsection{The $\pi$-ring Tricrystal Experiment with d-wave Superconductors}
...
\paragraph{Phase Shift and Supercurrent Orientation}
...
\paragraph{Tricrystal Geometry and Half-Integer Flux Quantization}
...
\paragraph{Observation with Scanning SQUID Microscopy}
...
\subsection{TODO:Applications of $\pi$-JJs: $\pi$-SQUIDs and Beyond}

\paragraph{Self-Biasing $\pi$-SQUIDs}
...
\paragraph{Charge and Spin Transport in SFS Junctions}
...
\paragraph{Flip-Flopping Fractional Flux Quanta}
...
\paragraph{Toggle Flip-Flop (TFF)}
...
\paragraph{Applications in Superconducting Digital and Quantum Circuits}
...
\paragraph{SFsFS and SIsFS Structures}
\begin{itemize}
...
\paragraph{Complex Current-Phase Relation (CPR)}
...
\subsection{Hybrid Josephson Junctions (Hybrid JJs)}
...
\paragraph{Superconducting Hybrid Devices}
...
\paragraph{Gate Voltage Control}
...
\paragraph{Emerging Materials and Layouts}
...
\paragraph{Advantages of Graphene and 2D Materials}
...
\subsection{The Resistively Shunted Junction (RSJ) Model}
...
\subsubsection{Thermal Activation and Macroscopic Quantum Tunneling}
...
\subsubsection{McCumber-Stewart Parameter}
...
\subsubsection{Temperature Dependence of $I_c$}
...
\subsubsection{Field Dependence of $I_c$}
...
\subsubsection{Josephson Penetration Depth $\lambda_J$}
...
\subsubsection{Spatial Distribution of the Current}
...
\subsection{The Evolution of Josephson Junction Technology}
...
\subsubsection{Early Developments: Soft Superconductors and Thermal Oxidation}
...
\subsubsection{Lead-Alloy Technology and Sputter-Oxidation}
...
\subsubsection{Transition to Rigid Superconductors: Nb and Artificial Barriers}
...
\subsubsection{Modern Multilayer SIS Thin-Film Junctions}
...
\subsubsection{Other Rigid Superconductors}
...
\subsection{High-Temperature Superconducting Junctions (HTS JJs)}

\subsubsection{YBa$_2$Cu$_3$O$_{7-x}$ (YBCO): The Most Studied HTS Compound}
...
\subsubsection{Challenges and Recent Progress}
...
\subsubsection{Unique Features of HTS JJs}
...
\subsection{Applications of Josephson Junctions}

\subsubsection{Voltage Metrology}
Josephson junctions are widely used in voltage metrology, providing highly accurate voltage standards.

\subsubsection{Nano-JJs and Nano-SQUIDs}
...
\section{Quantum Bits with Josephson Junctions}

\subsection{Basics of Superconducting Quantum Circuits with Josephson Junctions}
...
\subsection{Qubit: The Quantum Bit}
...
\end{itemize}
\subsection{Physical Implementation of Qubits: Why Josephson-Junction Qubits?}
...
\subsection{Why is a nonlinear element needed?}
...
\subsection{Operating Conditions for Josephson-Junction Qubits}
...
\subsection{Applications of Josephson Junctions in Qubits}
...
\subsubsection{Classical Lagrangian for the Circuit}
...
\subsubsection{Generalized Coordinates and Momenta}
...
\subsubsection{Hamiltonian of the Circuit}
...
\subsubsection{Examples of Josephson-Junction Qubits}
\paragraph{Charge Qubit:}
...
\paragraph{Fabrication Procedure:}
\begin{enumerate}
...
\subsection{Extensions and Refinements of the Three Basic Josephson-Junction Qubits}
...
\subsubsection{Quantronium Qubit}
...
\subsubsection{Design Developments for Scaling Up}
...
\subsubsection{Novel Qubit Designs}
...
\subsubsection{Motivation for Improved Qubit Design}
...
\subsection{Example of a JJ Qubit Realization, Control, and Readout}
\subsubsection{Xmon Qubit capacitively coupled to a quarter-wave resonator for readout}
...
\paragraph{Design and Realization}
...
\subsubsection{Example of a JJ Tunable Qubit Realization, Control, and Readout}

\paragraph{Tunability}
...
\paragraph{Readout in the Dispersive Limit}
...
\subsection{Qubit Control with SFQ Pulses}
...
\paragraph{Advantages of SFQ Pulses:}
\begin{itemize}
...
\subsection{TODO:Quantum Annealing and the D-Wave Quantum Annealer}
...
\subsubsection{Principles of Quantum Annealing}
...
\subsubsection{D-Wave Quantum Annealers}
...
\subsubsection{Fabrication and Technology}
...
\subsubsection{Applications of Quantum Annealing}
