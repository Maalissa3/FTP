...
\chapter{Epitaxy, CVD, ALD, PVD, electroplating}
...
\section{Classification by Mother Phase}
...
\section{Why is Epitaxy important?}
\begin{itemize}
...
\section{Vapor Phase Epitaxy (VPE) / Chemical Vapor Deposition (CVD)}

\subsection{VPE Details}
...
\section{Liquid Phase Epitaxy (LPE)}
\begin{itemize}
...
\section{Types of Chemical Vapor Deposition (CVD) Reactors}
...
\subsection{Atmospheric Pressure CVD (APCVD)}
...
\subsection{Low Pressure CVD (LPCVD)}
...
\subsection{Plasma Enhanced CVD (PECVD)}
...
\subsection{Plasma Generation} Applying voltage to a neutral gas accelerates free electrons. When voltage is increased, energetic electrons ionize or excite gas atoms (cascading collisions), sustaining the reaction. The glow visible in a plasma is emitted when excited gas atoms return to the ground state.The process causes:
\begin{itemize}
...
\section{PECVD process control parameters}
\begin{enumerate}
    \item Temperature.
...
\subsection{PECVD Pros and Cons}
Pros:
\begin{itemize}
...
\section{Atomic Layer Deposition(ALD)}
...
\section*{ALD Process Steps (Example: $Al_{2}O_{3}$)}
\begin{enumerate}
...
\subsection{ALD Characteristics}
\begin{itemize}
...
\section{Polycrystalline Silicon ("Poly")}
\begin{itemize}
...
\section{PVD-Thermal Evaporation}
\begin{center}
...
\subsection{Sputtering Conformality}
\begin{center}
...
\subsection{Ionized Sputtering (HDP Sputtering)}
